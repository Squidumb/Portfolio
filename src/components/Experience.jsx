  ...
  return (
    <>
      ...
      <motion.group
        ...
        animate={{
          z: section === 1 ? 0 : -10,
          y: section === 1 ? -viewport.height - 1.5 : -2, // Added -1 to move it down
        }}
      >
        ...
        <Float>
          <mesh position={[1, -3, -15]} scale={[2, 2, 2]}>
            <sphereGeometry />
            <MeshDistortMaterial opacity={1} transparent distort={0.4} speed={4} color={"red"} />
          </mesh>
        </Float>
        <Float>
      ...
      <group position-y={-viewport.height * 0.5 + 1.5}>
        <Projects />
      </group>
    </>
  )
